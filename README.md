...
検証済みのPythonのバージョンは`3.8.17`で、Raspberry Pi OSのバージョンはBullseyeです。
<font color="yellow">
Bullseyeより過去(Buster等)では動作しません。 (Pythonが3.7止まりになっていることが原因)
</font>
...
`python3 clova/test.py get_indexes`
